...
> **Gate:** фази магазину нижче не починаються, доки не прийнято Bridge MVP з `docs/BRIDGE_RUNBOOK.md`. Bridge є фазою `B0`, а не частиною десятиденного строку магазину.
